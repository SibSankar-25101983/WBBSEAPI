...
namespace DAL
{
    ...
    {
        //private static string vSrvName = System.Configuration.ConfigurationManager.AppSettings["SrvName"];
        ...
        public static string GetConStr()
        {
            ...
            string ConStr = "Data Source=DESKTOP-KQHU7QU\\MSSQLSERVER01; User Id=sa; Password=Sibu@123; Database=WBBSE_FINAL_DATA_PORT; Connect Timeout=360000; pooling='true'; Max Pool Size=200;";
            //  ConStr = "data source="+ vSrvName + "; Initial Catalog=" + vDBName + ";Integrated Security=True;";
            return ConStr;
        }
        ...
        public static byte[] ExecuteByteScaler(SqlCommand pCommand)
        {
            byte[] retByte = null;
            pCommand.Connection = GetConnection();
            pCommand.CommandTimeout = 3600;
            try
            {
                retByte = (byte[])pCommand.ExecuteScalar();
                return retByte;
            }
            catch (Exception ex)
            {
