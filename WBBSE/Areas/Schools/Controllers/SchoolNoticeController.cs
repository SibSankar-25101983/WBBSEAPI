...
namespace WBBSE.Areas.Schools.Controllers
{
    ...
    public class SchoolNoticeController : Controller
    {
        private int makeData(string encRoleId)
        {
            ...
            {
                MCommon.saveExceptionLog(ex.Message, "makeData", "SchoolNoticeController");
                status = -1;
            }
        ...
        public ActionResult Notice(string x)
        {
            ...
            {
                MCommon.saveExceptionLog(ex.Message, "Notice/View", "SchoolNoticeController");
                return Redirect("~/Error/Unexpected.html");
            }
        }
        ...
        public JsonResult GetSchoolInboxList(int? page, int? limit, string sortBy, string direction, string searchString = null, string contentType = null)
        {
            ...
            {
                MCommon.saveExceptionLog(ex.Message, "GetSchoolInboxList", "SchoolNoticeController");
            }

            var records = new MSchoolInboxs().getAdminSchoolInboxList(page, limit, sortBy, direction, ref total, searchString, archiveYN);
        ...
        public JsonResult UnreadNoticeListStatus()
        {
            ...
            Err = new MSchoolInboxs().updateAdminSchoolReadStatus();
