...
function GetSchoolCategoryList(d) {
    ...
    try {
        $.ajax({
            url: "/SchoolProfile/GetSchoolCategoryList",
            type: "GET",
            dataType: "json",
...
function GetSchoolTypeList(d) {
    ...
    try {
        $.ajax({
            url: "/SchoolProfile/GetSchoolTypeList",
            type: "GET",
            dataType: "json",
            contentType: "application/json",
            async: true,
...
function GetSchoolStatusList(d) {
    ...
    try {
        $.ajax({
            url: "/SchoolProfile/GetSchoolStatusList",
            type: "GET",
            dataType: "json",
            contentType: "application/json",
            async: true,
...
function GetSchoolMediumList(d) {
    ...
    try {
        $.ajax({
            url: "/SchoolProfile/GetSchoolMediumList",
            type: "GET",
            dataType: "json",
            contentType: "application/json",
            async: true,
...
function GetSchoolRecognitionList(d) {
    ...
    try {
        $.ajax({
            url: "/SchoolProfile/GetSchoolRecognitionList",
            type: "GET",
            dataType: "json",
            contentType: "application/json",
            async: true,
...
function GetSchoolManagementList(d) {
    ...
    try {
        $.ajax({
            url: "/SchoolProfile/GetSchoolManagementList",
            type: "GET",
            dataType: "json",
            contentType: "application/json",
            async: true,
...
function GetDesignationList(d) {
    ...
    try {
        $.ajax({
            url: "/SchoolProfile/GetDesignationList",
            type: "GET",
            dataType: "json",
            contentType: "application/json",
            async: true,
...
function Save() {
    ...
    try {
        if ($("#e").val() != setET(3)) {
            ...
            $.ajax({
                url: "/SchoolProfile/ChkDuplicateContact",
                type: "GET",
                dataType: "json",
                contentType: "application/json",
...
function View(e) {
    ...
    try {
        ...
        $.ajax({
            url: "/SchoolProfile/GetSchoolView",
            type: "GET",
            dataType: "json",
            data: { 's': '' + s + '' },
            contentType: "application/json",
        ...
        $.ajax({
            ...
            success: function (data) {
                if (data.Records.length > 0) {
                    ...
                    $("#e").val(setET(2));
                    $("#S").val(s);
                    $("#lblModalHeader").text("School Profile :: Edit Record [School Index No : " + data.Records[0].IndexNo + "]");
