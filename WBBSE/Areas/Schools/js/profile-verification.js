...
$(document).ready(function () {
    ...
    setTimeout(function () { $("#OldPassword").val(DefaultSetting.EmptyVal); $("#NewPassword").val(DefaultSetting.EmptyVal); $("#ConfirmPassword").val(DefaultSetting.EmptyVal); }, 500);
...
function GetSalutationList() {
    ...
    try {
        $.ajax({
            url: "/SchoolProfileVerification/GetSalutationList",
            type: "GET",
            dataType: "json",
