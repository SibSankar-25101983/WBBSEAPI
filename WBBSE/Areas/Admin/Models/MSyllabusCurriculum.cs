...
{
    public class MSyllabusCurriculum
    {
        public List<VMContentDetails> getSyllabusCurriculumList(int? page, int? limit, string sortBy, string direction, string menuCode, ref int total, string searchString, string archiveYN = "A")
        {
            ...
            {
                MCommon.saveExceptionLog(ex.Message, "GetSyllabusCurriculumList/getSyllabusCurriculumList(MSyllabusCurriculum)", "AdminSyllabusCurriculumController");
            }
            finally
            {
                dt = null;
        ...
        public int saveSyllabusCurriculum(HttpPostedFileBase[] postedFiles, VMContentDetails data, ref string errDesc)
        {
            ...
            try
            {
                ...
                if (mode != Mode.DELETE)
                {
                    ...
                    if (postedFiles[0] != null)
                    {
                        ...
                        dbFilePath = FilePath.SyllabusCurriculum;
                    }
                }

                filePath = HttpContext.Current.Server.MapPath("~/ReadWriteData/SyllabusCurriculum/");
                ...
                err = new DAL.Common().SaveContentDetails(ContentId, MenuCode.SyllabusCurriculum, linkTypeId, string.Empty, bodyText, string.Empty
                ...
                {
                    MCommon.saveExceptionLog(errDesc, "SyllabusCurriculum/saveSyllabusCurriculum(MSyllabusCurriculum)", "AdminSyllabusCurriculumController");
                    err = 1;
            ...
            {
                err = 1;
                MCommon.saveExceptionLog(ex.Message, "SyllabusCurriculum/saveSyllabusCurriculum(MSyllabusCurriculum)", "AdminSyllabusCurriculumController");
            }
