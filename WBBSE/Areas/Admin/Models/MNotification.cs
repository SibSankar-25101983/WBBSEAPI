...
namespace WBBSE.Areas.Admin.Models
{
    public class MNotification
    {
        public List<VMContentDetails> getNotificationList(int? page, int? limit, string sortBy, string direction, string menuCode, ref int total, string searchString, string archiveYN = "A")
        {
            ...
            {
                MCommon.saveExceptionLog(ex.Message, "GetNotificationList/getNotificationList(MNotification)", "AdminNotificationController");
            }
            finally
            {
                dt = null;
        ...
        public int saveNotification(HttpPostedFileBase[] postedFiles, VMContentDetails data, ref string errDesc)
        {
            ...
            string bodyText = string.Empty, URL = string.Empty, newYN = string.Empty, archiveYN = string.Empty, menuCode = string.Empty;
            ...
            try
            {
                ...
                if (mode != Mode.DELETE)
                {
                    ...
                    bodyText = Sanitizer.GetSafeHtmlFragment(data.BodyTextOriginal.Trim());
                    ...
                    if (postedFiles[0] != null)
                    {
                        ...
                        dbFilePath = FilePath.Notification;
                    }
                }

                filePath = HttpContext.Current.Server.MapPath("~/ReadWriteData/Notification/");
                ...
                err = new DAL.Common().SaveContentDetails(ContentId, menuCode, linkTypeId, string.Empty, bodyText, string.Empty
                ...
                {
                    MCommon.saveExceptionLog(errDesc, "Notification/saveNotification(MCircular)", "AdminNotificationController");
                    err = 1;
            ...
            {
                err = 1;
                MCommon.saveExceptionLog(ex.Message, "Notification/saveNotification(MCircular)", "AdminNotificationController");
            }
        ...
        public List<VMContentDetails> getNotificationTypeListDropDown()
        {
            ...
            {
                MCommon.saveExceptionLog(ex.Message, "GetNotificationTypeList/getNotificationTypeListDropDown(MNotification)", "AdminNotificationController");
            }
            finally
            {
                dt = null;
        ...
        public List<VMContentDetails> getWebNotificationList(int? page, int? limit, string sortBy, string direction, string menuCode, ref int total, string searchString, string archiveYN = "A")
        {
            DataTable dt = new DataTable();
            List<VMContentDetails> result = new List<VMContentDetails>();
            ...
            try
            {
                dt = new Notification().GetWebNotificationList(searchString, menuCode, page, limit, ref total, archiveYN);
            ...
            {
                MCommon.saveExceptionLog(ex.Message, "GetNotificationList/getWebNotificationList(MNotification)", "WebController");
            }
            finally
            {
                dt = null;
