...
namespace WBBSE.Areas.Admin.Models
{
    public class MEBooks
    {
        public List<VMContentDetails> getEBooksList(int? page, int? limit, string sortBy, string direction, string menuCode, ref int total, string searchString, string archiveYN = "A")
        {
            ...
            {
                MCommon.saveExceptionLog(ex.Message, "GetEBooksList/getEBooksList(MEBooks)", "AdminEBooksController");
            }
            finally
            {
                dt = null;
        ...
        public int saveEBook(HttpPostedFileBase[] postedFiles, VMContentDetails data, ref string errDesc)
        {
            ...
            try
            {
                ...
                if (mode != Mode.DELETE)
                {
                    ...
                    if (postedFiles[0] != null)
                    {
                        ...
                        dbFilePath = FilePath.EBooks;
                    }
                }

                filePath = HttpContext.Current.Server.MapPath("~/ReadWriteData/EBooks/");
                ...
                err = new DAL.Common().SaveContentDetails(ContentId, MenuCode.EBooks, linkTypeId, string.Empty, bodyText.ToUpper(), string.Empty
                ...
                {
                    MCommon.saveExceptionLog(errDesc, "EBooks/saveEBook(MEBooks)", "AdminEBooksController");
                    err = 1;
            ...
            {
                err = 1;
                MCommon.saveExceptionLog(ex.Message, "EBooks/saveEBook(MEBooks)", "AdminEBooksController");
            }
