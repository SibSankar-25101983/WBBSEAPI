...
namespace WBBSE.Areas.Admin.Models
{
    public class MModelQuestions
    {
        public List<VMContentDetails> getModelQuestionsList(int? page, int? limit, string sortBy, string direction, string menuCode, ref int total, string searchString, string archiveYN = "A")
        {
            ...
            {
                MCommon.saveExceptionLog(ex.Message, "GetModelQuestionsList/getModelQuestionsList(MModelQuestions)", "AdminModelQuestionsController");
            }
            finally
            {
                dt = null;
        ...
        public int saveModelQuestions(HttpPostedFileBase[] postedFiles, VMContentDetails data, ref string errDesc)
        {
            ...
            try
            {
                ...
                if (mode != Mode.DELETE)
                {
                    ...
                    if (postedFiles[0] != null)
                    {
                        ...
                        dbFilePath = FilePath.ModelQuestions;
                    }
                }

                filePath = HttpContext.Current.Server.MapPath("~/ReadWriteData/ModelQuestions/");
                ...
                err = new DAL.Common().SaveContentDetails(ContentId, MenuCode.ModelQuestions, linkTypeId, string.Empty, bodyText, string.Empty
                ...
                {
                    MCommon.saveExceptionLog(errDesc, "ModelQuestions/saveModelQuestions(MModelQuestions)", "AdminModelQuestionsController");
                    err = 1;
            ...
            {
                err = 1;
                MCommon.saveExceptionLog(ex.Message, "ModelQuestions/saveModelQuestions(MModelQuestions)", "AdminModelQuestionsController");
            }
