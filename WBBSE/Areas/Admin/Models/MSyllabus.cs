...
namespace WBBSE.Areas.Admin.Models
{
    public class MSyllabus
    {
        public List<VMContentDetails> getSyllabusList(int? page, int? limit, string sortBy, string direction, string menuCode, ref int total, string searchString, string archiveYN = "A")
        {
            ...
            {
                MCommon.saveExceptionLog(ex.Message, "GetSyllabusList/getSyllabusList(MSyllabus)", "AdminSyllabusController");
            }
            finally
            {
                dt = null;
        ...
        public int saveSyllabus(HttpPostedFileBase[] postedFiles, VMContentDetails data, ref string errDesc)
        {
            ...
            {                
                ...
                if (mode != Mode.DELETE)
                {
                    ...
                    if (postedFiles[0] != null)
                    {
                        ...
                        dbFilePath = FilePath.Syllabus;
                    }
                }

                filePath = HttpContext.Current.Server.MapPath("~/ReadWriteData/Syllabus/");
                ...
                err = new DAL.Common().SaveContentDetails(ContentId, MenuCode.Syllabus, linkTypeId, string.Empty, bodyText, string.Empty
                ...
                {
                    MCommon.saveExceptionLog(errDesc, "Syllabus/saveSyllabus(MSyllabus)", "AdminSyllabusController");
                    err = 1;
            ...
            {
                err = 1;
                MCommon.saveExceptionLog(ex.Message, "Syllabus/saveSyllabus(MSyllabus)", "AdminSyllabusController");
            }
