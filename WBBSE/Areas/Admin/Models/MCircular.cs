...
namespace WBBSE.Areas.Admin.Models
{
    public class MCircular
    {
        public List<VMContentDetails> getCircularList(int? page, int? limit, string sortBy, string direction, string menuCode, ref int total, string searchString, string archiveYN = "A")
        {
            ...
            {
                MCommon.saveExceptionLog(ex.Message, "GetCircularList/GetCircularList(MCircular)", "AdminCircularController");
            }
            finally
            {
                dt = null;
        ...
        public int saveCircular(HttpPostedFileBase[] postedFiles, VMContentDetails data, ref string errDesc)
        {
            ...
            try
            {
                ...
                if (mode != Mode.DELETE)
                {
                    ...
                    if (postedFiles[0] != null)
                    {
                        ...
                        dbFilePath = FilePath.Circular;
                    }
                }

                filePath = HttpContext.Current.Server.MapPath("~/ReadWriteData/Circular/");
                ...
                err = new DAL.Common().SaveContentDetails(ContentId, MenuCode.Circulars, linkTypeId, string.Empty, bodyText, string.Empty
                ...
                {
                    MCommon.saveExceptionLog(errDesc, "Circular/saveCircular(MCircular)", "AdminCircularController");
                    err = 1;
            ...
            {
                err = 1;
                MCommon.saveExceptionLog(ex.Message, "Circular/saveCircular(MCircular)", "AdminCircularController");
            }
