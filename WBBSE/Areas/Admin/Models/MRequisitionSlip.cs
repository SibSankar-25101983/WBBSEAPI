...
namespace WBBSE.Areas.Admin.Models
{
    public class MRequisitionSlip
    {
        public List<VMContentDetails> getRequisitionSlipList(int? page, int? limit, string sortBy, string direction, string menuCode, ref int total, string searchString, string archiveYN = "A")
        {
            ...
            {
                MCommon.saveExceptionLog(ex.Message, "GetRequisitionSlipList/getRequisitionSlipList(MRequisitionSlip)", "AdminRequisitionSlipController");
            }
            finally
            {
                dt = null;
        ...
        public int saveRequisitionSlip(HttpPostedFileBase[] postedFiles, VMContentDetails data, ref string errDesc)
        {
            ...
            try
            {
                ...
                if (mode != Mode.DELETE)
                {
                    ...
                    if (postedFiles[0] != null)
                    {
                        ...
                        dbFilePath = FilePath.RequisitionSlip;
                    }
                }

                filePath = HttpContext.Current.Server.MapPath("~/ReadWriteData/RequisitionSlip/");
                ...
                err = new DAL.Common().SaveContentDetails(ContentId, MenuCode.RequisitionSlip, linkTypeId, string.Empty, bodyText, string.Empty
                ...
                {
                    MCommon.saveExceptionLog(errDesc, "RequisitionSlip/saveRequisitionSlip(MRequisitionSlip)", "AdminRequisitionSlipController");
                    err = 1;
            ...
            {
                err = 1;
                MCommon.saveExceptionLog(ex.Message, "RequisitionSlip/saveRequisitionSlip(MRequisitionSlip)", "AdminRequisitionSlipController");
            }
