...
namespace WBBSE.Areas.Admin.Models
{
    public class MRTI
    {
        public List<VMContentDetails> getRTIList(int? page, int? limit, string sortBy, string direction, string menuCode, ref int total, string searchString, string archiveYN = "A")
        {
            ...
            {
                MCommon.saveExceptionLog(ex.Message, "GetRTIList/getRTIList(MRTI)", "AdminRTIController");
            }
            finally
            {
                dt = null;
        ...
        public List<VMContentDetails> getRTIListDropDown()
        {
            DataTable dt = new DataTable();
            List<VMContentDetails> result = new List<VMContentDetails>();
            ...
            {
                MCommon.saveExceptionLog(ex.Message, "GetModuleList/getRTIListDropDown(MRTI)", "AdminRTIController");
            }
            finally
            {
                dt = null;
        ...
        public int saveRTI(HttpPostedFileBase[] postedFiles, VMContentDetails data, ref string errDesc)
        {
            ...
            try
            {
                ...
                if (mode != Mode.DELETE)
                {
                    ...
                    if (postedFiles[0] != null)
                    {
                        ...
                        dbFilePath = FilePath.RTI;
                    }
                }

                filePath = HttpContext.Current.Server.MapPath("~/ReadWriteData/RTI/");
                ...
                {
                    MCommon.saveExceptionLog(errDesc, "RTI/saveRTI(MDownloadForms)", "AdminRTIController");
                    err = 1;
                    errDesc = Message.OperationError;
                    return err;
                }
            ...
            {
                err = 1;
                MCommon.saveExceptionLog(ex.Message, "RTI/saveRTI(MDownloadForms)", "AdminRTIController");
            }
