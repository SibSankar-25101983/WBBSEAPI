...
namespace WBBSE.Areas.Admin.Models
{
    public class MDownloadForms
    {
        public List<VMContentDetails> getDownloadFormsList(int? page, int? limit, string sortBy, string direction, string menuCode, ref int total, string searchString, string archiveYN = "A")
        {
            ...
            {
                MCommon.saveExceptionLog(ex.Message, "GetDownloadFormsList/getDownloadFormsList(MDownloadForms)", "AdminDownloadFormsController");
            }
            finally
            {
                dt = null;
        ...
        public int saveDownloadForms(HttpPostedFileBase[] postedFiles, VMContentDetails data, ref string errDesc)
        {
            ...
            try
            {
                ...
                if (mode != Mode.DELETE)
                {
                    ...
                    if (postedFiles[0] != null)
                    {
                        ...
                        dbFilePath = FilePath.DownloadForms;
                    }
                }

                filePath = HttpContext.Current.Server.MapPath("~/ReadWriteData/DownloadForms/");
                ...
                err = new DAL.Common().SaveContentDetails(ContentId, MenuCode.DownloadForms, linkTypeId, string.Empty, bodyText, string.Empty
                ...
                {
                    MCommon.saveExceptionLog(errDesc, "Forms/saveDownloadForms(MDownloadForms)", "AdminDownloadFormsController");
                    err = 1;
            ...
            {
                err = 1;
                MCommon.saveExceptionLog(ex.Message, "Forms/saveDownloadForms(MDownloadForms)", "AdminDownloadFormsController");
            }
