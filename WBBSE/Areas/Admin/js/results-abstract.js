...
function GetLinkTypeList(d) {
    ...
    try {
        $.ajax({
            url: "/AdminResultsAbstract/GetLinkTypeList",
            type: "GET",
            dataType: "json",
...
function Add() {
    ...
    $("#lblModalHeader").text("Results (Abstract) :: Add New");
...
function Edit(e) {
    ...
    try {
        ...
        $("#lblModalHeader").text("Results (Abstract) :: Edit");
...
function Search() {
    $("#GridResultsAbstract").off('DOMSubtreeModified', chkMod);
