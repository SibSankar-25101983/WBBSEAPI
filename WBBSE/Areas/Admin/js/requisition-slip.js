...
function GetLinkTypeList(d) {
    ...
    try {
        $.ajax({
            url: "/AdminRequisitionSlip/GetLinkTypeList",
            type: "GET",
            dataType: "json",
...
function Add() {
    ...
    $("#lblModalHeader").text("Requisition Slip :: Add New");
...
function Edit(e) {
    ...
    try {
        ...
        $("#lblModalHeader").text("Requisition Slip :: Edit");
...
function Search() {
    $("#GridRequisitionSlip").off('DOMSubtreeModified', chkMod);
