...
{
    public partial class MstSchoolRecognition : System.Web.UI.Page
    {
            ...
            if (!IsPostBack)
            {
                try
                {
                    ...
                    else
                    {
                        ...
                        DataTable dt = new MSchoolParameters().DownloadMstSchoolRecognitionList(1, MaxFileSize.RecordCount, null, null, string.Empty, ref total, Convert.ToInt32(ReportFormat.Pdf));

                        if (dt != null)
                        {
                            ReportViewer1.ProcessingMode = ProcessingMode.Local;
                            ReportViewer1.LocalReport.ReportPath = Server.MapPath("~/Reporting/RDLC/RptMstSchoolRecognition.rdlc");
                            ...
                            ReportDataSource rdc = new ReportDataSource("DsMstSchoolRecognition", dt);
                            ...
                            Response.AppendHeader("Content-Disposition", "attachment; filename=SchoolRecognition List." + extension);
                ...
                {
                    MCommon.saveExceptionLog(ex.Message, "Page_Load", "Reporting/MstSchoolRecognition");
                }
            }
        }
    }
