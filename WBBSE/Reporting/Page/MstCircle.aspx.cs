...
{
    public partial class MstCircle : System.Web.UI.Page
    {
            ...
            if (!IsPostBack)
            {
                try
                {
                    ...
                    else
                    {
                        ...
                        DataTable dt = new MMstCircle().downloadMstCircleList(1, MaxFileSize.RecordCount, null, null, string.Empty, ref total, Convert.ToInt32(ReportFormat.Pdf));

                        if (dt != null)
                        {
                            ReportViewer1.ProcessingMode = ProcessingMode.Local;
                            ReportViewer1.LocalReport.ReportPath = Server.MapPath("~/Reporting/RDLC/RptMstCircle.rdlc");
                            ...
                            ReportDataSource rdc = new ReportDataSource("DsMstCircle", dt);
                            ...
                            Response.AppendHeader("Content-Disposition", "attachment; filename=Circle List." + extension);
                ...
                {
                    MCommon.saveExceptionLog(ex.Message, "Page_Load", "Reporting/MstCircle");
                }
            }
        }
    }
