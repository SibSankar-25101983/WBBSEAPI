...
{
    public partial class MstBlock : System.Web.UI.Page
    {
            ...
            if (!IsPostBack)
            {
                try
                {
                    ...
                    else
                    {
                        ...
                        DataTable dt = new MMstBlock().downloadMstBlockList(1, MaxFileSize.RecordCount, null, null, string.Empty, ref total, Convert.ToInt32(ReportFormat.Pdf));

                        if (dt != null)
                        {
                            ReportViewer1.ProcessingMode = ProcessingMode.Local;
                            ReportViewer1.LocalReport.ReportPath = Server.MapPath("~/Reporting/RDLC/RptMstBlock.rdlc");
                            ...
                            ReportDataSource rdc = new ReportDataSource("DsMstBlock", dt);
                            ...
                            Response.AppendHeader("Content-Disposition", "attachment; filename=Block List." + extension);
                ...
                {
                    MCommon.saveExceptionLog(ex.Message, "Page_Load", "Reporting/MstBlock");
                }
            }
        }
    }
