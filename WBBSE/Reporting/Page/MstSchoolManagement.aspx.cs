...
{
    public partial class MstSchoolManagement : System.Web.UI.Page
    {
            ...
            if (!IsPostBack)
            {
                try
                {
                    ...
                    else
                    {
                        ...
                        DataTable dt = new MSchoolParameters().DownloadMstSchoolManagementList(1, MaxFileSize.RecordCount, null, null, string.Empty, ref total, Convert.ToInt32(ReportFormat.Pdf));

                        if (dt != null)
                        {
                            ReportViewer1.ProcessingMode = ProcessingMode.Local;
                            ReportViewer1.LocalReport.ReportPath = Server.MapPath("~/Reporting/RDLC/RptMstSchoolManagement.rdlc");
                            ...
                            ReportDataSource rdc = new ReportDataSource("DsMstSchoolManagement", dt);
                            ...
                            Response.AppendHeader("Content-Disposition", "attachment; filename=SchoolManagement List." + extension);
                ...
                {
                    MCommon.saveExceptionLog(ex.Message, "Page_Load", "Reporting/MstSchoolManagement");
                }
            }
        }
    }
