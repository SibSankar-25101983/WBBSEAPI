...
{
    public partial class MstSubDivision : System.Web.UI.Page
    {
            ...
            if (!IsPostBack)
            {
                try
                {
                    ...
                    else
                    {
                        ...
                        DataTable dt = new MMstSubDivision().DownloadMstSubDivisionList(1, MaxFileSize.RecordCount, null, null, string.Empty, ref total, Convert.ToInt32(ReportFormat.Pdf));

                        if (dt != null)
                        {
                            ReportViewer1.ProcessingMode = ProcessingMode.Local;
                            ReportViewer1.LocalReport.ReportPath = Server.MapPath("~/Reporting/RDLC/RptMstSubDivision.rdlc");
                            ...
                            ReportDataSource rdc = new ReportDataSource("DsMstSubDivision", dt);
                            ...
                            Response.AppendHeader("Content-Disposition", "attachment; filename=SubDivision List." + extension);
                ...
                {
                    MCommon.saveExceptionLog(ex.Message, "Page_Load", "Reporting/MstSubDivision");
                }
            }
        }
    }
