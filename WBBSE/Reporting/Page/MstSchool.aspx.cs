...
{
    public partial class MstSchool : System.Web.UI.Page
    {
            ...
            if (!IsPostBack)
            {
                try
                {
                    ...
                    else
                    {
                        ...
                        DataTable dt = new MMstSchool().downloadMstSchoolList(1, MaxFileSize.RecordCount, null, null, string.Empty, ref total, SearchType.School.SchoolName, SearchType.SchoolProfile.All, Convert.ToInt32(ReportFormat.Pdf));

                        if (dt != null)
                        {
                            ReportViewer1.ProcessingMode = ProcessingMode.Local;
                            ReportViewer1.LocalReport.ReportPath = Server.MapPath("~/Reporting/RDLC/RptMstSchool.rdlc");
                            ...
                            ReportDataSource rdc = new ReportDataSource("DsMstSchool", dt);
                            ...
                            Response.AppendHeader("Content-Disposition", "attachment; filename=School List." + extension);
                ...
                {
                    MCommon.saveExceptionLog(ex.Message, "Page_Load", "Reporting/MstSchool");
                }
            }
        }
    }
