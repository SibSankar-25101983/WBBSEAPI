...
{
    public partial class MstZone : System.Web.UI.Page
    {
            ...
            if (!IsPostBack)
            {
                try
                {
                    ...
                    else
                    {
                        ...
                        DataTable dt = new MMstZone().DownloadMstZoneList(1, MaxFileSize.RecordCount, null, null, string.Empty, ref total, Convert.ToInt32(ReportFormat.Pdf));

                        if (dt != null)
                        {
                            ReportViewer1.ProcessingMode = ProcessingMode.Local;
                            ReportViewer1.LocalReport.ReportPath = Server.MapPath("~/Reporting/RDLC/RptMstZone.rdlc");
                            ...
                            ReportDataSource rdc = new ReportDataSource("DsMstZone", dt);
                            ...
                            Response.AppendHeader("Content-Disposition", "attachment; filename=Zone List." + extension);
                ...
                {
                    MCommon.saveExceptionLog(ex.Message, "Page_Load", "Reporting/MstZone");
                }
            }
        }
    }
