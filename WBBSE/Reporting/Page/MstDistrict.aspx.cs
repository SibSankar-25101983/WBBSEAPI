...
{
    public partial class MstDistrict : System.Web.UI.Page
    {
            ...
            if (!IsPostBack)
            {
                try
                {
                    ...
                    else
                    {
                        ...
                        DataTable dt = new MMstDistrict().DownloadMstDistrictList(1, MaxFileSize.RecordCount, null, null, string.Empty, ref total, Convert.ToInt32(ReportFormat.Pdf));

                        if (dt != null)
                        {
                            ReportViewer1.ProcessingMode = ProcessingMode.Local;
                            ReportViewer1.LocalReport.ReportPath = Server.MapPath("~/Reporting/RDLC/RptMstDistrict.rdlc");
                            ...
                            ReportDataSource rdc = new ReportDataSource("DsMstDistrict", dt);
                            ...
                            Response.AppendHeader("Content-Disposition", "attachment; filename=District List." + extension);
                ...
                {
                    MCommon.saveExceptionLog(ex.Message, "Page_Load", "Reporting/MstDistrict");
                }
            }
        }
    }
