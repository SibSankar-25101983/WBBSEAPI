...
namespace DAL
{
    public class Result
    {
        public DataTable GetResultsAbstractList(string searchString, string menuCode, int? pageNo, int? pageSize, ref int totalCount, string archiveYN)
        {
            ...
            try
            {
                ...
                oCmd.CommandText = "GetResultsAbstractList";
