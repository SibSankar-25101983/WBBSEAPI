...
namespace DAL
{
    public class Tender
    {
        public DataTable GetTenderList(string searchString, string menuCode, int? pageNo, int? pageSize, ref int totalCount, string archiveYN)
        {
            ...
            try
            {
                ...
                oCmd.CommandText = "GetTenderList";
