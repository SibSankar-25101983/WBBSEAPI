...
namespace DAL
{
    ...
    {
        public DataTable GetModelQuestionsList(string searchString, string menuCode, int? pageNo, int? pageSize, ref int totalCount, string archiveYN)
        {
            ...
            try
            {
                ...
                oCmd.CommandText = "GetModelQuestionsList";
