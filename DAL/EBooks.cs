...
namespace DAL
{
    public class EBooks
    {
        public DataTable GetEBooksList(string searchString, string menuCode, int? pageNo, int? pageSize, ref int totalCount, string archiveYN)
        {
            ...
            try
            {
                ...
                oCmd.CommandText = "GetEBooksList";
