...
namespace DAL
{
    ...
    {
        public DataTable GetRequisitionSlipList(string searchString, string menuCode, int? pageNo, int? pageSize, ref int totalCount, string archiveYN)
        {
            ...
            try
            {
                ...
                //oCmd.CommandText = "GetDownloadFormsList";
                oCmd.CommandText = "GetRequisitionSlipList";
