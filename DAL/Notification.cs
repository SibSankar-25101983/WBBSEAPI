...
namespace DAL
{
    ...
    {
        public DataTable GetNotificationList(string searchString, string menuCode, int? pageNo, int? pageSize, ref int totalCount, string archiveYN)
        {
            ...
            try
            {
                ...
                oCmd.CommandText = "GetNotificationList";
        ...
        public DataTable GetNotificationTypeListDropDown()
        {
            SqlCommand oCmd = new SqlCommand();
            DataTable dt = new DataTable();
            ...
            {
                oCmd.CommandType = CommandType.StoredProcedure;
                oCmd.CommandText = "GetNotificationTypeListDropDown";
                DBUtility.ExecuteForSelect(oCmd, dt);
            }
            catch
            {
        ...
        public DataTable GetWebNotificationList(string searchString, string menuCode, int? pageNo, int? pageSize, ref int totalCount, string archiveYN)
        {
            SqlCommand oCmd = new SqlCommand();
            DataTable dt = new DataTable();
            ...
            {
                oCmd.CommandType = CommandType.StoredProcedure;
                oCmd.CommandText = "GetWebNotificationList";
                DBUtility.AddParameter(oCmd.Parameters, ParameterDirection.Input, SqlDbType.VarChar, 100, "@pSearchString", searchString);
                DBUtility.AddParameter(oCmd.Parameters, ParameterDirection.Input, SqlDbType.VarChar, 20, "@pMenuCode", menuCode);
                DBUtility.AddParameter(oCmd.Parameters, ParameterDirection.Input, SqlDbType.Int, 10, "@pPageNo", pageNo);
                DBUtility.AddParameter(oCmd.Parameters, ParameterDirection.Input, SqlDbType.Int, 10, "@pPageSize", pageSize);
                DBUtility.AddParameter(oCmd.Parameters, ParameterDirection.Output, SqlDbType.Int, 10, "@pTotalCount", totalCount);
                DBUtility.AddParameter(oCmd.Parameters, ParameterDirection.Input, SqlDbType.Char, 1, "@pArchiveYN", archiveYN);
