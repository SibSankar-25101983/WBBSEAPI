...
namespace DAL
{
    ...
    {
        public DataTable GetCircularList(string searchString, string menuCode, int? pageNo, int? pageSize, ref int totalCount, string archiveYN)
        {
            ...
            try
            {
                ...
                oCmd.CommandText = "GetCircularList";
