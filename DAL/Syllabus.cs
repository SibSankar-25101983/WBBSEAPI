...
namespace DAL
{
    ...
    {
        public DataTable GetSyllabusList(string searchString, string menuCode, int? pageNo, int? pageSize, ref int totalCount, string archiveYN)
        {
            ...
            try
            {
                ...
                oCmd.CommandText = "GetSyllabusList";
